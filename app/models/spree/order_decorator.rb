Spree::Order.class_eval do
  ...
  state_machine.after_transition to: :complete, do: :create_referral_benefit
  ...
  private
    ...
    def create_referral_benefit
      if referral.present?
        store_credit = create_store_credits(referral.user) if referrer_eligible?(referral.user)
