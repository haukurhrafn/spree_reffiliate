module Spree
  class ReferralCommissionRule < Spree::Base
    with_options required: true do
      belongs_to :referral, class_name: 'Spree::Referral', inverse_of: :referral_commission_rules
    ...
    validates :referral_id, uniqueness: { scope: :commission_rule_id, allow_blank: true }
